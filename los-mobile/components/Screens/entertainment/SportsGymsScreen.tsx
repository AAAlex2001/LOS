              ...
              <View key={gym.id} style={styles.card}>
                {gym.image_url && (
                  <View style={styles.imageContainer}>
                    <Image 
                      source={{ uri: toImageUrl(gym.image_url) }}
                ...
                <View style={styles.infoContainer}>
                  {gym.name && (
                    gym.name_link ? (
                      <TouchableOpacity onPress={() => openLink(gym.name_link)}>
                        <Text style={[styles.gymName, styles.underline]}>{gym.name}</Text>
                      </TouchableOpacity>
                    ) : (
