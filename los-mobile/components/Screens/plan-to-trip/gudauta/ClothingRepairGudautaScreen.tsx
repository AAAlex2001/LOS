...
export default function ClothingRepairGudautaScreen({
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        const res = await fetch(`${API_BASE}/api/clothing-repair/page/city_page/${encodeURIComponent(t('cities.gudauta'))}/`, { cache: 'no-store' });
