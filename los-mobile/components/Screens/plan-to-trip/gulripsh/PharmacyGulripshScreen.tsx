...
export default function PharmacyGulripshScreen({
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        const res = await fetch(`${API_BASE}/api/pharmacy/page/city_page/${encodeURIComponent(t('cities.gulripsh'))}/`, { cache: 'no-store' });
