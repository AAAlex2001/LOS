...
export default function CulturalAttractionsGulripshScreen({
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        const res = await fetch(`${API_BASE}/api/cultural-attractions/page/city_page/${encodeURIComponent(t('cities.gulripsh'))}/`, { cache: 'no-store' });
