...
export default function AdministrativeBuildingsPitsundaScreen({
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        const res = await fetch(`${API_BASE}/api/administrative-buildings/page/city_page/${encodeURIComponent(t('cities.pitsunda'))}/`, { cache: 'no-store' });
