...
export default function WineriesGagraScreen({
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        const res = await fetch(`${API_BASE}/api/wineries/page/city_page/${encodeURIComponent(t('cities.gagra'))}/`, { cache: 'no-store' });
