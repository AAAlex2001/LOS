...
import styles from './ClothingRepairOchamchira.module.scss';
...
const ClothingRepairOchamchira: React.FC = () => {
  ...
  React.useEffect(() => {
    const load = async () => {
      try {
        const url = getApiUrl(`/api/clothing-repair/page/city_page/${encodeURIComponent('Очамчыра')}/`, locale);
      ...
      <main className={styles.mainContent}>
        <div className={styles.buildingsWrapper}>
          ...
          <section className={styles.titleSection}>
            <h1 className={styles.mainTitle}>{data?.title || 'Очамчыра: ремонт одежды и обуви'}</h1>
          </section>
...
export default ClothingRepairOchamchira;
