...
const churches = [
  {
    id: 1,
    name: 'Илорский храм, Церковь Георгия Победоносца',
    address: 'Очамчырский район, село Илор',
    addressLink: 'https://yandex.com/maps/-/CDxdiI5T',
    workingHours: 'с 09:00 до 18:00',
    image: '/assets/ChurchesOchamchira1.jpg',
  },
];
    ...
    <div className={styles.pageWrapper}>
      ...
      <main className={styles.mainContent}>
        <section className={styles.titleSection}>
          <h1 className={styles.mainTitle}>Очамчыра: церкви и храмы</h1>
        </section>
