...
import styles from './ChurchesOchamchira.module.scss';
...
const ChurchesOchamchira: React.FC = () => {
    ...
    <div className={styles.pageWrapper}>
      ...
      <main className={styles.mainContent}>
        <section className={styles.titleSection}>
          <h1 className={styles.mainTitle}>{data?.title || 'Очамчыра: церкви и храмы'}</h1>
        </section>
...
export default ChurchesOchamchira;