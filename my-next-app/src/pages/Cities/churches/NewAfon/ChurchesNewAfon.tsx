...
import styles from './ChurchesNewAfon.module.scss';

const churches = [
  {
    id: 1,
    name: 'Собор Пантелеимона Целителя',
    address: 'Гудаутский район, Новый Афон',
    addressLink: 'https://yandex.com/maps/-/CDxH4U7D',
    workingHours: 'с 09:00 до 19:00, понедельник выходной.',
    image: '/assets/ChurchesNewAfon1.jpg',
  },
  {
    id: 2,
    name: 'Храм Симона Кананита',
    address: 'г.Новый Афон, ул.Эшба 8',
    workingHours: 'с 09:00 до 17:00',
    image: '/assets/ChurchesNewAfon2.jpg',
  },
];

const ChurchesNewAfon: React.FC = () => {
  return (
    <div className={styles.pageWrapper}>
      ...
      <main className={styles.mainContent}>
        <section className={styles.titleSection}>
          <h1 className={styles.mainTitle}>Новый Афон: церкви и храмы</h1>
        </section>
...
export default ChurchesNewAfon; 