...
const CarWashesTkuarchal: React.FC = () => {
  ...
  React.useEffect(() => {
    const load = async () => {
      try {
        const url = getApiUrl(`/api/car-washes/page/city_page/${encodeURIComponent('Ткуарчал')}/`, locale);
...
export default CarWashesTkuarchal;
