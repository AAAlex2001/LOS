...
import styles from './PharmacyGudauta.module.scss';
...
const PharmacyGudauta: React.FC = () => {
      ...
      <main className={styles.mainContent}>
        <div className={styles.buildingsWrapper}>
          ...
          <section className={styles.titleSection}>
            <h1 className={styles.mainTitle}>{data?.title || 'Гудаута: аптеки'}</h1>
          </section>
...
export default PharmacyGudauta;
