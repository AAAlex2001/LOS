...
const pharmacies = [
  {
    ...
    address: 'Гудаута, Адыгская улица',
    addressLink: 'https://yandex.com/maps/-/CDxrqI76',
    contacts: null,
    image: '/assets/PharmacyGudauta1.jpg'
  },
];
    ...
    <div className={styles.pageWrapper}>
      ...
      <main className={styles.mainContent}>
        <section className={styles.titleSection}>
          <h1 className={styles.mainTitle}>Гудаута: аптеки</h1>
        </section>
