...
const AdministrativeBuildingsTkuarchal: React.FC = () => {
  ...
  const city = data?.cities.find(c => c.name.toLowerCase().includes('ткуарч'));
    ...
    <div className={styles.pageWrapper}>
      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.titleSection}>
          <h1 className={styles.mainTitle}>{city?.title || 'Ткуарчал: административные здания, правоохранительный блок'}</h1>
        </section>
