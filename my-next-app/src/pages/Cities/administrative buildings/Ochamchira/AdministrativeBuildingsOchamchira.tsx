...
import styles from './AdministrativeBuildingsOchamchira.module.scss';

// Данные административных зданий
const administrativeBuildings = [
  {
    id: 1,
    name: 'Администрация города Очамчира',
    nameLink: null,
    workingHours: 'с 09:00 до 17:00',
    address: 'Очамчыра, ул. Баграта Шинкуба, 73',
...
const AdministrativeBuildingsOchamchira: React.FC = () => {
  return (
    <div className={styles.pageWrapper}>
      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.titleSection}>
          <h1 className={styles.mainTitle}>Очамчыра: административные здания, правоохранительный блок</h1>
        </section>
...
export default AdministrativeBuildingsOchamchira; 