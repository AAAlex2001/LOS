...
import styles from './BeautySalonsGulripsh.module.scss';
...
const beautySalons: {
  ...
  {
    id: 1,
    name: 'Juli Beauti studio',
    address: 'посёлок городского типа Агудзера, улица Курчатова',
    addressLink: 'https://yandex.com/maps/-/CDxHuO~-',
    workingHours: 'с 09:00 до 20:00',
    image: '/assets/city_gulripsh.jpg',
  },
];

const BeautySalonsGulripsh: React.FC = () => {
  return (
    <div className={styles.pageWrapper}>
      ...
      <main className={styles.mainContent}>
        <section className={styles.titleSection}>
          <h1 className={styles.mainTitle}>Гулрыпш: салоны красоты</h1>
        </section>
...
export default BeautySalonsGulripsh; 