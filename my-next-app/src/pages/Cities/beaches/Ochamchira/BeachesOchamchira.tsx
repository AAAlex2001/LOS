...
import styles from './BeachesOchamchira.module.scss';

// Данные пляжей
// TODO: Replace with actual images for Ochamchira beaches
const beaches = [
  {
    id: 1,
    name: 'Пляж',
    address: 'Очамчира',
    addressLink: 'https://yandex.com/maps/-/CDxd4ZoR',
    image: '/assets/BeachesOchamchira1.png',
  },
];

const BeachesOchamchira: React.FC = () => {
  return (
    <div className={styles.pageWrapper}>
      ...
      <main className={styles.mainContent}>
        <section className={styles.titleSection}>
          <h1 className={styles.mainTitle}>Очамчира: пляжи</h1>
        </section>
...
export default BeachesOchamchira;