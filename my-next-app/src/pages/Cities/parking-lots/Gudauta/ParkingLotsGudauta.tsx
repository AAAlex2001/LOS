...
import styles from './ParkingLotsGudauta.module.scss';
...
const ParkingLotsGudauta: React.FC = () => {
      ...
      <main className={styles.mainContent}>
        <div className={styles.buildingsWrapper}>
          ...
          <section className={styles.titleSection}>
            <h1 className={styles.mainTitle}>{data?.title || 'Гудаута: парковки для автомобилей'}</h1>
          </section>
...
export default ParkingLotsGudauta;
