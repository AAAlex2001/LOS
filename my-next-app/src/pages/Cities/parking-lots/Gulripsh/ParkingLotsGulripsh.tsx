...
import styles from './ParkingLotsGulripsh.module.scss';
      ...
      <main className={styles.mainContent}>
        <div className={styles.buildingsWrapper}>
          ...
          <section className={styles.titleSection}>
            <h1 className={styles.mainTitle}>{data?.title || 'Гулрыпш: парковки для автомобилей'}</h1>
          </section>
...
export default ParkingLotsGulripsh;
