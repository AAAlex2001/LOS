...
import styles from './ParkingLotsPitsunda.module.scss';
...
const ParkingLotsPitsunda: React.FC = () => {
      ...
      <main className={styles.mainContent}>
        <div className={styles.buildingsWrapper}>
          ...
          <section className={styles.titleSection}>
            <h1 className={styles.mainTitle}>{data?.title || 'Пицунда: парковки для автомобилей'}</h1>
          </section>
...
export default ParkingLotsPitsunda;
