...
import styles from './ParkingLotsTkuarchal.module.scss';
...
const ParkingLotsTkuarchal: React.FC = () => {
      ...
      <main className={styles.mainContent}>
        <div className={styles.buildingsWrapper}>
          ...
          <section className={styles.titleSection}>
            <h1 className={styles.mainTitle}>{data?.title || 'Ткуарчал: парковки для автомобилей'}</h1>
          </section>
...
export default ParkingLotsTkuarchal;
