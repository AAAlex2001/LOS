...
import styles from './HotelsTkuarchal.module.scss';

// Данные отелей
const hotels = [
  {
    id: 1,
    name: 'Радоновый источник',
    address: 'Ткуарчалский район',
    addressLink: 'https://yandex.ru/maps/-/CDBW6WNb',
    contacts: '+7 (940) 716-77-37',
    price: '2000р за ночь для двух гостей',
    image: '/assets/HotelsTkuarchal1.jpg',
  },
];

const HotelsTkuarchal: React.FC = () => {
  return (
    <div className={styles.pageWrapper}>
      ...
      <main className={styles.mainContent}>
        <section className={styles.titleSection}>
          <h1 className={styles.mainTitle}>Ткуарчал: отели</h1>
        </section>
...
export default HotelsTkuarchal; 