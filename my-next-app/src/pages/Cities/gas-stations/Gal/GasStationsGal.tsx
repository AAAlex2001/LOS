...
import styles from './GasStationsGal.module.scss';
...
const GasStationsGal: React.FC = () => {
  ...
  React.useEffect(() => {
    const load = async () => {
      try {
        const url = getApiUrl(`/api/gas-stations/page/city_page/${encodeURIComponent('Гал')}/`, locale);
