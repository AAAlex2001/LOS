    ...
    <div className={styles.pageWrapper}>
      ...
      <main className={styles.mainContent}>
        ...
        <nav className={styles.tabsContainer}>
            <a href="#history" className={styles.tabItem}>История Абхазии</a>
            <a href="#culture" className={styles.tabItem}>Культура Абхазии</a>
        </nav>
        
        <h2 id="history" className={styles.contentTitle}>История Абхазии</h2>

        <ImageBlock src="/assets/big_image.jpg" alt="Абхазы" width={1000} height={796}/>
        ...
        <ImageBlock src="/assets/IMG_1932.jpg" alt="Абхазы" width={1000} height={798}/>
        ...
        <ImageBlock src="/assets/activity_gornye_marshruty.jpg" alt="Абхазы" width={1000} height={709}/>
        ...
        <ImageBlock src="/assets/city_gagra.jpg" alt="Абхазы" width={1000} height={564}/>
        ...
        <h2 id="culture" className={`${styles.contentTitle} ${styles.spacedTitle}`}>Культура Абхазии</h2>

        <ImageBlock src="/assets/city_sukhum.jpg" alt="Абхазы" width={1000} height={521}/>
