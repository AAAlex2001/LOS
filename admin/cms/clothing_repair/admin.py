...
class ClothingRepairInline(admin.TabularInline):
    ...
    extra = 1
    fields = ("name", "name_link", "working_hours", "address", "address_link", "contacts", "description", "services", "image", "order", "preview")
